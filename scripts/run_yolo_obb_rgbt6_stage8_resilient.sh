...
CONFIG_PATH="${PROJECT_ROOT}/configs/yolo_obb_rgbt6_stage8_resume_from_v3_lowmem.yaml"
LOG_PATH="${PROJECT_ROOT}/outputs/official_rgbt6_full_official_speedup_v3_resume.log"
