...
CONFIG_PATH="${1:?usage: run_yolo_obb_experiment_resilient.sh <config_path> <log_path>}"
LOG_PATH="${2:?usage: run_yolo_obb_experiment_resilient.sh <config_path> <log_path>}"
