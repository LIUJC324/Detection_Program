...
CONFIG_PATH="${PROJECT_ROOT}/configs/yolo_obb_official_rgb_stage1_stable.yaml"
LOG_PATH="${PROJECT_ROOT}/outputs/yolo_obb_official_stage1_stable_20260412_resume.log"
